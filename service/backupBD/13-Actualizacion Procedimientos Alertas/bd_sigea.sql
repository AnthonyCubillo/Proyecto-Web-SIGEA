...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-04-2023 a las 01:43:32
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_actualizar_alerta` (IN `n_etiqueta` VARCHAR(50), IN `marca` VARCHAR(50), IN `modelo` VARCHAR(50), IN `serie` VARCHAR(50), IN `descripcion` VARCHAR(250), IN `id_ubicacion` INT, IN `valor_libro` VARCHAR(50), IN `condicion` VARCHAR(50), IN `clase_activo` VARCHAR(50), IN `id_funcionario` INT, IN `estado` TINYINT(1))   BEGIN
    ...
    SET a.marca = marca,
        ...
        a.id_ubicacion = id_ubicacion,
        a.valor_libro = valor_libro,
        a.condicion = condicion,
        a.clase_activo = clase_activo,
        a.id_funcionario = id_funcionario,
        a.estado = estado
...
('N0000', 'Prueba2', 'Prueba', 'Prueba', 'Prueba', 1, '1', 'Prueba', 'Prueba', 1, 1),
('N10101', 'Prueba', 'Prueba', 'Prueba', 'Prueba', 1, '1', 'Prueba', 'Prueba', 1, 1);

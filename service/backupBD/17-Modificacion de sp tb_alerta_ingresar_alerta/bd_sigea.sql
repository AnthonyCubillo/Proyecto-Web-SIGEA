...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-04-2023 a las 22:06:50
...
(1, 'N00114280', 'HEWLETT PACKARD', 'DC5750', 'MXJ80807XG', 'COMPUTADORA DE ESCRITORIO', 1, '0.00', 'En desuso', 'computadoras', 1, '2023-04-19', 0);
...
--
ALTER TABLE `tb_alerta`
  MODIFY `tb_alerta_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

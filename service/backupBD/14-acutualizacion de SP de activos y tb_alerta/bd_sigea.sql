...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 16, 2023 at 07:54 PM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `tb_alerta_ingresar_alerta` (IN `alerta_n_etiqueta` VARCHAR(50), IN `alerta_marca` VARCHAR(50), IN `alerta_modelo` VARCHAR(50), IN `alerta_serie` VARCHAR(50), IN `alerta_activo_descripcion` VARCHAR(250), IN `alerta_ubicacion` INT, IN `alerta_valor_libro` VARCHAR(50), IN `alerta_condicion` VARCHAR(50), IN `alerta_clase_activo` VARCHAR(50), IN `alerta_id_funcionario` INT, IN `alerta_activo_estado` TINYINT(1), IN `alerta_fecha` DATETIME(3), IN `alerta_tipo_alerta` VARCHAR(50), IN `alerta_detalle` VARCHAR(250), IN `alerta_accion` VARCHAR(50))   BEGIN
    INSERT INTO tb_alerta(tb_alerta_n_etiqueta, tb_alerta_marca, tb_alerta_modelo, tb_alerta_serie,
                          ...
                          tb_alerta_activo_estado, tb_alerta_fecha, tb_alerta_tipo_alerta, tb_alerta_detalle,
                          tb_alerta_accion)
    VALUES (alerta_n_etiqueta, alerta_marca, alerta_modelo, alerta_serie, alerta_activo_descripcion,
            ...
            alerta_id_funcionario, alerta_activo_estado, alerta_fecha, alerta_tipo_alerta,
            alerta_detalle, alerta_accion);
END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `tb_alerta_mostrar_alertas` ()   BEGIN
    SELECT tb_alerta_id, tb_alerta_n_etiqueta, tb_alerta_marca, tb_alerta_modelo, tb_alerta_serie,
           ...
           tb_alerta_tipo_alerta, tb_alerta_detalle, tb_alerta_accion
    FROM tb_alerta
...
CREATE TABLE `tb_alerta` (
  ...
  `tb_alerta_n_etiqueta` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `tb_alerta_marca` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `tb_alerta_modelo` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `tb_alerta_serie` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `tb_alerta_activo_descripcion` varchar(250) COLLATE utf8_spanish_ci NOT NULL,
  `tb_alerta_ubicacion` int(11) DEFAULT NULL,
  `tb_alerta_valor_libro` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `tb_alerta_condicion` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `tb_alerta_clase_activo` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `tb_alerta_id_funcionario` int(11) NOT NULL,
  `tb_alerta_activo_estado` tinyint(1) NOT NULL,
  `tb_alerta_fecha` datetime(3) NOT NULL,
  `tb_alerta_tipo_alerta` varchar(50) COLLATE utf8_spanish_ci NOT NULL,
  `tb_alerta_detalle` varchar(250) COLLATE utf8_spanish_ci NOT NULL,
  `tb_alerta_accion` varchar(50) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
--
ALTER TABLE `tb_alerta`
  MODIFY `tb_alerta_id` int(11) NOT NULL AUTO_INCREMENT;

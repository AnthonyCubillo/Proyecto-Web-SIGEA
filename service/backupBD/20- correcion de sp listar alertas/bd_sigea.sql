...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-05-2023 a las 03:50:03
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `tb_alerta_mostrar_alertas` ()   BEGIN
    ...
    tb_alerta_id, tb_alerta_n_etiqueta, tb_alerta_marca, tb_alerta_modelo, tb_alerta_serie,
           ...
           tb_alerta_clase_activo, tb_alerta_id_funcionario, tb_alerta_fecha,
           tb_alerta_tipo_alerta
    FROM tb_alerta
    INNER JOIN tb_funcionario as fun on fun.id_funcionario = tb_alerta.tb_alerta_id
...
(1, 'N00114280', 'marca', 'modelo', 'serie', 'descripcion', 1, '000', 'condicion uso', 'clase activo', 1, '2023-04-19', 3),
(16, '66666', 'marca', 'modelo', 'serie', 'descripcion', 1, '000', 'condicion uso', 'clase activo', 1, '2023-04-29', 1),
(18, '9788', 'Bonaldaaaaaaa', 'A4D0', 'N/A', 'Escritorio gris, con cajones', 1, '300 000', 'En uso', 'Mesa y escritorios', 1, '2023-04-30', 1);

...
class Activo{
  ...
  //constrctor para actualizar
  public static function constructorActualizar($n_etiqueta, $marca, $modelo, $serie, $descripcion, $id_ubicacion, $valor_libro, $condicion, $clase_activo, $id_funcionario){
    return new self($n_etiqueta, $marca, $modelo, $serie, $descripcion, $id_ubicacion, '', $valor_libro, $condicion, $clase_activo, $id_funcionario, '');
  }

   //constrctor para actualizar sin ubicacion
   public static function constructorEditar($n_etiqueta, $marca, $modelo, $serie, $descripcion, $valor_libro, $condicion, $clase_activo, $id_funcionario){
    return new self($n_etiqueta, $marca, $modelo, $serie, $descripcion,'','',$valor_libro, $condicion, $clase_activo, $id_funcionario,'');
  }
